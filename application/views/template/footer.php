  ...
  <div id="right-menu">
      <ul class="nav nav-tabs">
        <li class="active">
         <a data-toggle="tab" href="<?php echo base_url(); ?>#right-menu-user">
          <span class="fa fa-comment-o fa-2x"></span>
         </a>
        </li>
        <li>
         <a data-toggle="tab" href="<?php echo base_url(); ?>#right-menu-notif">
          <span class="fa fa-bell-o fa-2x"></span>
         </a>
        </li>
        <li>
          <a data-toggle="tab" href="<?php echo base_url(); ?>#right-menu-config">
      ...
      <div class="tab-content">
        <div id="right-menu-user" class="tab-pane fade in active">
          ...
          <div class="user col-md-12">
           <ul class="nav nav-list">
            <li class="online">
              <img src="<?php echo base_url(); ?>public/asset/img/avatar.jpg" alt="user name">
              <div class="name">
        ...
        <div class="col-md-12 chatbox">
          <div class="col-md-12">
            <a href="<?php echo base_url(); ?>#" class="close-chat">X</a><h4>Akihiko Avaron</h4>
          </div>
          <div class="chat-area">
                ...
                <div class="row msg_container send">
                  <div class="col-md-9 col-xs-9 bubble">
                    ...
                    <div class="col-md-3 col-xs-3 avatar">
                      <img src="<?php echo base_url(); ?>public/asset/img/avatar.jpg" class=" img-responsive " alt="user name">
                    </div>
                  </div>
                        ...
                        <ul>
                          <li class="online">
                            <a href=""  data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                              <div class="user-avatar"><img src="<?php echo base_url(); ?>public/asset/img/avatar.jpg" alt="user name"></div>
                              <div class="dot"></div>
                            </a>
                          </li>
                          <li class="offline">
                  ...
                  <li class="mini-timeline-highlight">
                   <div class="mini-timeline-panel">
                    ...
                    <p>Meeting with <a href="<?php echo base_url(); ?>#">Clients</a></p>
                  </div>
                </li>
...
<div class="mimin-mobile-menu-list">
    <div class="col-md-12 sub-mimin-mobile-menu-list animated fadeInLeft">
        <ul class="nav nav-list">
            ...
            <li class="ripple">
              <a href="<?php echo base_url(); ?>public/calendar.html">
